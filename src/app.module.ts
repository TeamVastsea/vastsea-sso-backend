...
const BUILT_IN_PERMISSIONS = [
  ...
  'AUTH::ACCOUNT::REMOVE',
  'AUTH::ACCOUNT::UPDATE',
  'AUTH::ACCOUNT::KICKOUT',
  'AUTH::ACCOUNT::QUERY::INFO',
  'AUTH::ACCOUNT::QUERY::LIST',
  'AUTH::CLIENT::CREATE',
  'AUTH::CLIENT::REMOVE',
  'AUTH::CLIENT::REMOVE::*',
  'AUTH::CLIENT::UPDATE',
  'AUTH::CLIENT::UPDATE::*',
  'AUTH::CLIENT::QUERY::INFO',
  'AUTH::CLIENT::QUERY::INFO::*',
  'AUTH::CLIENT::QUERY::LIST',
  'AUTH::CLIENT::QUERY::LIST::*',
  'AUTH::PERMISSION::CREATE',
  'AUTH::PERMISSION::CREATE::*',
  'AUTH::PERMISSION::REMOVE',
  'AUTH::PERMISSION::REMOVE::*',
  'AUTH::PERMISSION::UPDATE',
  'AUTH::PERMISSION::UPDATE::*',
  'AUTH::PERMISSION::QUERY::LIST',
  'AUTH::PERMISSION::QUERY::LIST::*',
  'AUTH::PERMISSION::QUERY::INFO',
  'AUTH::PERMISSION::QUERY::INFO::*',
  'AUTH::ROLE::CREATE',
  'AUTH::ROLE::CREATE::*',
  'AUTH::ROLE::REMOVE',
  ...
  'AUTH::ROLE::UPDATE',
  'AUTH::ROLE::UPDATE::*',
  'AUTH::ROLE::QUERY::INFO',
  'AUTH::ROLE::QUERY::INFO::*',
  'AUTH::ROLE::QUERY::LIST',
  'AUTH::ROLE::QUERY::LIST::*',
  'AUTH-SERVER::LOGIN',
];
